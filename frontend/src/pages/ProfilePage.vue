      ...
      <div class="grid gap-4 lg:grid-cols-2">
        <section class="rounded-2xl border border-gray-100 bg-white p-5 shadow-card dark:border-gray-700 dark:bg-gray-800">
          <div class="mb-4 flex items-center justify-between">
            <h2 class="text-base font-bold text-gray-900 dark:text-white">tema yang sudah dibeli</h2>
            <RouterLink to="/gamification" class="text-sm font-bold text-primary-600">toko tema</RouterLink>
          </div>

          <div v-if="redeemedRewards.length === 0" class="rounded-xl bg-gray-50 p-4 text-sm text-gray-500 dark:bg-gray-900/50">
            belum ada tema yang dibeli.
          </div>
        ...
        <section class="rounded-2xl border border-gray-100 bg-white p-5 shadow-card dark:border-gray-700 dark:bg-gray-800">
          ...
          <dl class="space-y-3 text-sm">
            ...
            <div class="flex justify-between gap-4">
              <dt class="text-gray-500">poin tema</dt>
...
const stats = computed(() => [
  ...
  { label: 'poin tema', value: profile.value.rewardPoints || 0 },
])
